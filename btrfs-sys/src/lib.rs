...
pub const btrfs_tlv_type_BTRFS_TLV_U8: btrfs_tlv_type = 0;
pub const btrfs_tlv_type_BTRFS_TLV_U16: btrfs_tlv_type = 1;
pub const btrfs_tlv_type_BTRFS_TLV_U32: btrfs_tlv_type = 2;
pub const btrfs_tlv_type_BTRFS_TLV_U64: btrfs_tlv_type = 3;
pub const btrfs_tlv_type_BTRFS_TLV_BINARY: btrfs_tlv_type = 4;
pub const btrfs_tlv_type_BTRFS_TLV_STRING: btrfs_tlv_type = 5;
pub const btrfs_tlv_type_BTRFS_TLV_UUID: btrfs_tlv_type = 6;
pub const btrfs_tlv_type_BTRFS_TLV_TIMESPEC: btrfs_tlv_type = 7;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of btrfs_stream_header"][::std::mem::size_of::<btrfs_stream_header>() - 17usize];
    ["Alignment of btrfs_stream_header"][::std::mem::align_of::<btrfs_stream_header>() - 1usize];
    ["Offset of field: btrfs_stream_header::magic"]
        [::std::mem::offset_of!(btrfs_stream_header, magic) - 0usize];
    ["Offset of field: btrfs_stream_header::version"]
        [::std::mem::offset_of!(btrfs_stream_header, version) - 13usize];
};
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of btrfs_cmd_header"][::std::mem::size_of::<btrfs_cmd_header>() - 10usize];
    ["Alignment of btrfs_cmd_header"][::std::mem::align_of::<btrfs_cmd_header>() - 1usize];
    ["Offset of field: btrfs_cmd_header::len"]
        [::std::mem::offset_of!(btrfs_cmd_header, len) - 0usize];
    ["Offset of field: btrfs_cmd_header::cmd"]
        [::std::mem::offset_of!(btrfs_cmd_header, cmd) - 4usize];
    ["Offset of field: btrfs_cmd_header::crc"]
        [::std::mem::offset_of!(btrfs_cmd_header, crc) - 6usize];
};
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of btrfs_tlv_header"][::std::mem::size_of::<btrfs_tlv_header>() - 4usize];
    ["Alignment of btrfs_tlv_header"][::std::mem::align_of::<btrfs_tlv_header>() - 1usize];
    ["Offset of field: btrfs_tlv_header::tlv_type"]
        [::std::mem::offset_of!(btrfs_tlv_header, tlv_type) - 0usize];
    ["Offset of field: btrfs_tlv_header::tlv_len"]
        [::std::mem::offset_of!(btrfs_tlv_header, tlv_len) - 2usize];
};
pub const btrfs_send_cmd_BTRFS_SEND_C_UNSPEC: btrfs_send_cmd = 0;
pub const btrfs_send_cmd_BTRFS_SEND_C_SUBVOL: btrfs_send_cmd = 1;
pub const btrfs_send_cmd_BTRFS_SEND_C_SNAPSHOT: btrfs_send_cmd = 2;
pub const btrfs_send_cmd_BTRFS_SEND_C_MKFILE: btrfs_send_cmd = 3;
pub const btrfs_send_cmd_BTRFS_SEND_C_MKDIR: btrfs_send_cmd = 4;
pub const btrfs_send_cmd_BTRFS_SEND_C_MKNOD: btrfs_send_cmd = 5;
pub const btrfs_send_cmd_BTRFS_SEND_C_MKFIFO: btrfs_send_cmd = 6;
pub const btrfs_send_cmd_BTRFS_SEND_C_MKSOCK: btrfs_send_cmd = 7;
pub const btrfs_send_cmd_BTRFS_SEND_C_SYMLINK: btrfs_send_cmd = 8;
pub const btrfs_send_cmd_BTRFS_SEND_C_RENAME: btrfs_send_cmd = 9;
pub const btrfs_send_cmd_BTRFS_SEND_C_LINK: btrfs_send_cmd = 10;
pub const btrfs_send_cmd_BTRFS_SEND_C_UNLINK: btrfs_send_cmd = 11;
pub const btrfs_send_cmd_BTRFS_SEND_C_RMDIR: btrfs_send_cmd = 12;
pub const btrfs_send_cmd_BTRFS_SEND_C_SET_XATTR: btrfs_send_cmd = 13;
pub const btrfs_send_cmd_BTRFS_SEND_C_REMOVE_XATTR: btrfs_send_cmd = 14;
pub const btrfs_send_cmd_BTRFS_SEND_C_WRITE: btrfs_send_cmd = 15;
pub const btrfs_send_cmd_BTRFS_SEND_C_CLONE: btrfs_send_cmd = 16;
pub const btrfs_send_cmd_BTRFS_SEND_C_TRUNCATE: btrfs_send_cmd = 17;
pub const btrfs_send_cmd_BTRFS_SEND_C_CHMOD: btrfs_send_cmd = 18;
pub const btrfs_send_cmd_BTRFS_SEND_C_CHOWN: btrfs_send_cmd = 19;
pub const btrfs_send_cmd_BTRFS_SEND_C_UTIMES: btrfs_send_cmd = 20;
pub const btrfs_send_cmd_BTRFS_SEND_C_END: btrfs_send_cmd = 21;
pub const btrfs_send_cmd_BTRFS_SEND_C_UPDATE_EXTENT: btrfs_send_cmd = 22;
pub const btrfs_send_cmd___BTRFS_SEND_C_MAX: btrfs_send_cmd = 23;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of btrfs_send_ops"][::std::mem::size_of::<btrfs_send_ops>() - 168usize];
    ["Alignment of btrfs_send_ops"][::std::mem::align_of::<btrfs_send_ops>() - 8usize];
    ["Offset of field: btrfs_send_ops::subvol"]
        [::std::mem::offset_of!(btrfs_send_ops, subvol) - 0usize];
    ["Offset of field: btrfs_send_ops::snapshot"]
        [::std::mem::offset_of!(btrfs_send_ops, snapshot) - 8usize];
    ["Offset of field: btrfs_send_ops::mkfile"]
        [::std::mem::offset_of!(btrfs_send_ops, mkfile) - 16usize];
    ["Offset of field: btrfs_send_ops::mkdir"]
        [::std::mem::offset_of!(btrfs_send_ops, mkdir) - 24usize];
    ["Offset of field: btrfs_send_ops::mknod"]
        [::std::mem::offset_of!(btrfs_send_ops, mknod) - 32usize];
    ["Offset of field: btrfs_send_ops::mkfifo"]
        [::std::mem::offset_of!(btrfs_send_ops, mkfifo) - 40usize];
    ["Offset of field: btrfs_send_ops::mksock"]
        [::std::mem::offset_of!(btrfs_send_ops, mksock) - 48usize];
    ["Offset of field: btrfs_send_ops::symlink"]
        [::std::mem::offset_of!(btrfs_send_ops, symlink) - 56usize];
    ["Offset of field: btrfs_send_ops::rename"]
        [::std::mem::offset_of!(btrfs_send_ops, rename) - 64usize];
    ["Offset of field: btrfs_send_ops::link"]
        [::std::mem::offset_of!(btrfs_send_ops, link) - 72usize];
    ["Offset of field: btrfs_send_ops::unlink"]
        [::std::mem::offset_of!(btrfs_send_ops, unlink) - 80usize];
    ["Offset of field: btrfs_send_ops::rmdir"]
        [::std::mem::offset_of!(btrfs_send_ops, rmdir) - 88usize];
    ["Offset of field: btrfs_send_ops::write"]
        [::std::mem::offset_of!(btrfs_send_ops, write) - 96usize];
    ["Offset of field: btrfs_send_ops::clone"]
        [::std::mem::offset_of!(btrfs_send_ops, clone) - 104usize];
    ["Offset of field: btrfs_send_ops::set_xattr"]
        [::std::mem::offset_of!(btrfs_send_ops, set_xattr) - 112usize];
    ["Offset of field: btrfs_send_ops::remove_xattr"]
        [::std::mem::offset_of!(btrfs_send_ops, remove_xattr) - 120usize];
    ["Offset of field: btrfs_send_ops::truncate"]
        [::std::mem::offset_of!(btrfs_send_ops, truncate) - 128usize];
    ["Offset of field: btrfs_send_ops::chmod"]
        [::std::mem::offset_of!(btrfs_send_ops, chmod) - 136usize];
    ["Offset of field: btrfs_send_ops::chown"]
        [::std::mem::offset_of!(btrfs_send_ops, chown) - 144usize];
    ["Offset of field: btrfs_send_ops::utimes"]
        [::std::mem::offset_of!(btrfs_send_ops, utimes) - 152usize];
    ["Offset of field: btrfs_send_ops::update_extent"]
        [::std::mem::offset_of!(btrfs_send_ops, update_extent) - 160usize];
};
extern "C" {
    pub fn btrfs_read_and_process_send_stream(
        fd: ::std::os::raw::c_int,
        ops: *mut btrfs_send_ops,
        user: *mut ::std::os::raw::c_void,
        honor_end_cmd: ::std::os::raw::c_int,
        max_errors: u64_,
    ) -> ::std::os::raw::c_int;
}
